...
export const categoryMeta: Record<string, { label: string; color: string; bg?: string; textColor: string }> = {
  ...
  retro:     { label: '80- & 90-tal', color: '#FF00E5', bg: '#4a0035', textColor: '#fff' },
  damer_gubbar: { label: 'Damer vs Gubbar',   color: '#FF5A5F', bg: '#2b0a12', textColor: '#fff' },
  dejt:         { label: 'Dejt & Dating',     color: '#FF477E', textColor: '#fff' },
  livskunskap:  { label: 'Detta bör du veta', color: '#0EA5E9', textColor: '#111' },
  citat:        { label: 'Vem sa det?',       color: '#FFB800', bg: '#0f1b3d', textColor: '#fff' },
}
...
export const packs: Record<string, Pack[]> = {
  ...
  disney: [
    ...
    },
    {
      ...
      type: 'sangfallan',
      songs: [
        { line: 'Hakuna Matata, what a wonderful phrase', song: 'Hakuna Matata', artist: 'Lejonkungen', hints: [
          'Låten är från en Disney-film om djur i Afrika',
          "Titeln är en swahili-fras som betyder 'inga bekymmer'",
          'Filmen kom ut på 1990-talet',
          'Karaktärerna som sjunger den är en surikat och ett vårtsvin',
          'Frasen blev så populär att den fick ett eget uppslag i ordböcker',
          'Filmen har en av Disneys mest kända öppningsscener med ett soluppgångstema',
        ] },
        { line: 'Let it go, let it go', song: 'Let It Go', artist: 'Frozen', hints: [
          'Låten är från en animerad film om två systrar',
          'Huvudkaraktären bygger ett isslott medan hon sjunger',
          'Filmen kom ut på 2010-talet',
          "Den svenska titeln är 'Släpp det fritt'",
          'Låten vann en Oscar för bästa sång',
          'Den sjöngs in på dussintals olika språk för filmens internationella lansering',
        ] },
        { line: "You've got a friend in me", song: "You've Got a Friend in Me", artist: 'Toy Story', hints: [
          'Låten är från en animerad film om leksaker som lever',
          'Filmen var Pixars första långfilm',
          'Filmen kom ut på 1990-talet',
          'Huvudkaraktären är en cowboydocka',
          'Låten sjungs av låtskrivaren själv, inte av en filmkaraktär',
          'Den återanvänds i alla uppföljarna till filmen',
        ] },
        { line: 'A whole new world', song: 'A Whole New World', artist: 'Aladdin', hints: [
          'Låten är en duett från en film om en gatpojke i Agrabah',
          'Karaktärerna sjunger den under en flygtur på en matta',
          'Filmen kom ut på 1990-talet',
          'Huvudkaraktären har en tam apa som bästa vän',
        ] },
        { line: 'Tale as old as time', song: 'Beauty and the Beast', artist: 'Skönheten och Odjuret', hints: [
          'Låten är från en film om en prinsessa och ett förtrollat odjur',
          'En kandelaber vid namn Lumière medverkar i filmen',
          'Filmen kom ut på 1990-talet',
          'Filmen var den första animerade filmen som nominerades till Oscar för bästa film',
          'Låten sjungs medan huvudpersonerna dansar i en balsal',
        ] },
        { line: 'When you wish upon a star', song: 'When You Wish Upon a Star', artist: 'Pinocchio', hints: [
          'Låten är från en av Disneys allra tidigaste långfilmer',
          'Filmen handlar om en trädocka som vill bli en riktig pojke',
          'Filmen kom ut på 1940-talet',
          'Huvudkaraktärens samvete är en syrsa',
          'Melodin används fortfarande som Walt Disney-bolagets signaturmelodi',
          'Låten vann en Oscar redan då den kom ut',
        ] },
        { line: "How far I'll go", song: "How Far I'll Go", artist: 'Moana', hints: [
          'Låten är från en film om en flicka som seglar ut på havet',
          'Huvudkaraktären är dotter till en hövding på en ö i Stilla havet',
          'Filmen kom ut på 2010-talet',
          'Halvguden Maui reser tillsammans med henne',
        ] },
        { line: "It's the circle of life", song: 'Circle of Life', artist: 'Lejonkungen', hints: [
          'Låten öppnar en av Disneys mest kända filmer',
          'Filmen handlar om ett lejon som blir kung',
          'Filmen kom ut på 1990-talet',
          'Låten sjungs i filmens allra första scen, när djuren samlas',
          'Den sjungs delvis på zulu, ett sydafrikanskt språk',
        ] },
      ],
    },
  ],
  ...
  rock: [
    ...
    },
    {
      ...
      type: 'sangfallan',
      songs: [
        { line: 'We will, we will rock you', song: 'We Will Rock You', artist: 'Queen', hints: [
          'Låten kom ut på 1970-talet',
          'Den har inget vanligt trumset — bara stamp och klapp',
          'Bandet kommer från Storbritannien',
          'Låten är en av rockhistoriens mest använda stadion-sånger',
          'Bandets sångare hette Freddie',
          'Låten skrevs för att publiken skulle kunna vara med utan instrument',
        ] },
        { line: "It's the eye of the tiger", song: 'Eye of the Tiger', artist: 'Survivor', hints: [
          'Låten kom ut på 1980-talet',
          'Den skrevs på beställning för en boxningsfilm efter att en annan låt inte fick användas',
          'Bandet kommer från USA',
          'Låten är mest känd som träningsmontage-tema i filmen',
          'Filmen handlar om en boxare vid namn Rocky',
          'Titeln handlar om ett rovdjur',
        ] },
        { line: "Oh, we're halfway there", song: "Livin' on a Prayer", artist: 'Bon Jovi', hints: [
          'Låten kom ut på 1980-talet',
          'Det är en power ballad om ett par som kämpar ekonomiskt',
          'Bandet kommer från New Jersey, USA',
          'Sångaren delar förnamn med bandet',
        ] },
        { line: "Don't stop believin'", song: "Don't Stop Believin'", artist: 'Journey', hints: [
          'Låten kom ut i början av 1980-talet',
          'Den blev ett viralt fenomen igen decennier senare tack vare en TV-serie',
          'Bandet kommer från San Francisco, USA',
        ] },
        { line: "I'm on the highway to hell", song: 'Highway to Hell', artist: 'AC/DC', hints: [
          'Låten kom ut på 1970-talet',
          'Det är en av hårdrockens mest kända titlar någonsin',
          'Bandet kommer från Australien',
          'Sångaren på albumet dog bara några månader senare',
          'Bandets namn är en elektrisk term',
          'Låten är ofta bandets allra sista låt på konserter',
        ] },
        { line: "We're not gonna take it", song: "We're Not Gonna Take It", artist: 'Twisted Sister', hints: [
          'Låten kom ut på 1980-talet',
          'Bandet är känt för sin flamboyanta glam metal-stil',
          'Bandet kommer från USA',
          'Låten blev en trotsig hymn för tonåringar',
          'Musikvideon är känd för sin överdrivna, tecknad-serie-aktiga stil',
        ] },
        { line: 'Here we are now, entertain us', song: 'Smells Like Teen Spirit', artist: 'Nirvana', hints: [
          'Låten kom ut i början av 1990-talet',
          'Den räknas som grunge-genrens stora genombrott',
          'Bandet kommer från Seattle, USA',
          'Titeln kommer från en deodorant-referens en vän skrev på en vägg',
          'Sångaren hette Kurt',
          'Låten gjorde bandets album till en oväntad succé över en natt',
        ] },
        { line: "Sweet child o' mine", song: "Sweet Child O' Mine", artist: "Guns N' Roses", hints: [
          'Låten kom ut på 1980-talet',
          'Den inleds med ett av rockhistoriens mest kända gitarriff',
          'Bandet kommer från Los Angeles, USA',
          'Gitarristen är känd för sin cylinderhatt',
        ] },
      ],
    },
  ],
  ...
  country: [
    ...
    },
    {
      ...
      type: 'sangfallan',
      songs: [
        { line: 'Country roads, take me home', song: 'Take Me Home, Country Roads', artist: 'John Denver', hints: [
          'Låten kom ut på 1970-talet',
          'Den hyllar delstaten West Virginia',
          'Artisten kommer från USA',
          'Artistens efternamn är samma som huvudstaden i Colorado',
          'Delstaten den handlar om har gjort den till en officiell delstatssång',
        ] },
        { line: 'Jolene, Jolene, Jolene, Jolene', song: 'Jolene', artist: 'Dolly Parton', hints: [
          'Låten kom ut på 1970-talet',
          'Den handlar om att be en annan kvinna att inte ta ens man',
          'Artisten kommer från Tennessee, USA',
          'Artisten driver även en nöjespark med liknande namn',
        ] },
        { line: 'I fell into a burning ring of fire', song: 'Ring of Fire', artist: 'Johnny Cash', hints: [
          'Låten kom ut på 1960-talet',
          'Den har ett distinkt mariachi-trumpetinslag',
          'Artisten kommer från USA',
          "Artisten kallades ofta 'The Man in Black'",
          'Låten skrevs egentligen av en kvinna i artistens liv, inte av honom själv',
          'Trumpetljudet sägs ha kommit till artisten i en dröm',
          'Titeln syftar bildligt på att vara förälskad',
          'Låten har spelats in av oräkneliga andra artister genom åren',
        ] },
        { line: "I've got friends in low places", song: 'Friends in Low Places', artist: 'Garth Brooks', hints: [
          'Låten kom ut på 1990-talet',
          'Den handlar om att trösta sig med vänner efter ett brustet hjärta',
          'Artisten kommer från Oklahoma, USA',
          'Artisten är en av countryns mest sålda artister genom tiderna',
          'Refrängen handlar om en bar, inte om pengar eller status',
          'Låten blev en av countryns mest sjungna karaoke-klassiker',
        ] },
        { line: "You've got to know when to hold 'em", song: 'The Gambler', artist: 'Kenny Rogers', hints: [
          'Låten kom ut på 1970-talet',
          'Den handlar om ett råd från en främling på ett tåg',
          'Artisten kommer från Texas, USA',
          'Låten inspirerade en hel filmserie med samma artist i huvudrollen',
          'Rådet i låten handlar om att veta när man ska sluta spela',
          'Låten vann ett Grammy-pris',
          'Den anses vara artistens signaturlåt framför alla andra',
          'Texten liknar mer en kort berättelse än en vanlig låt',
        ] },
        { line: 'Man, I feel like a woman', song: 'Man! I Feel Like a Woman!', artist: 'Shania Twain', hints: [
          'Låten kom ut på 1990-talet',
          'Den blandar country med poprock',
          'Artisten kommer från Kanada',
          'Artisten är en av de mest sålda kvinnliga countryartisterna genom tiderna',
          'Titelns utropstecken finns med i låtens riktiga titel',
          'Musikvideon visar artisten i en svart frackliknande outfit',
        ] },
        { line: 'On the road again', song: 'On the Road Again', artist: 'Willie Nelson', hints: [
          'Låten kom ut på 1980-talet',
          'Den skrevs till en film om ett countryband på turné',
          'Artisten kommer från Texas, USA',
          'Artisten är känd för sina flätor och sin gitarr vid namn Trigger',
        ] },
        { line: "Crazy, I'm crazy for feeling so lonely", song: 'Crazy', artist: 'Patsy Cline', hints: [
          'Låten kom ut på 1960-talet',
          'Den skrevs av en då okänd låtskrivare som senare blev stjärna själv',
          'Artisten kommer från Virginia, USA',
          'Artisten dog i en flygolycka 1963',
          'Låtskrivaren bakom den är mest känd för sina egna countrylåtar idag',
          'Låten räknas som en av jukebox-historiens mest spelade låtar',
          'Den spelades ursprungligen in på bara en enda tagning',
        ] },
      ],
    },
  ],
  ...
  musik: [
    ...
    },
    {
      ...
      type: 'sangfallan',
      songs: [
        { line: 'You are the dancing queen', song: 'Dancing Queen', artist: 'ABBA', hints: [
          'Låten kom ut på 1970-talet',
          'Bandet kommer från Sverige',
          'Den handlar om en 17-åring på dansgolvet',
          'Bandet består av två par som senare skilde sig',
          'Låten spelades först upp live inför ett kungligt bröllop',
        ] },
        { line: 'Is this the real life', song: 'Bohemian Rhapsody', artist: 'Queen', hints: [
          'Låten kom ut på 1970-talet',
          'Den är nästan sex minuter lång och har ingen vanlig refräng',
          'Bandet kommer från Storbritannien',
          'Den blandar ballad, operasektion och hårdrock i samma spår',
          'Låten låg långt över radions normala längdgräns när den släpptes',
        ] },
        { line: 'Billie Jean is not my lover', song: 'Billie Jean', artist: 'Michael Jackson', hints: [
          'Låten kom ut på 1980-talet',
          'Den har en av poppens mest ikoniska basgångar',
          'Artisten kommer från USA',
          "Artisten kallades 'The King of Pop'",
          'Låten handlar om en kvinna som påstår sig ha fått artistens barn',
          'Musikvideon var en av de första av en svart artist som fick tung rotation på en stor musikkanal',
        ] },
        { line: "Hey Jude, don't make it bad", song: 'Hey Jude', artist: 'The Beatles', hints: [
          'Låten kom ut på 1960-talet',
          "Den avslutas med en lång 'na na na'-refräng",
          'Bandet kommer från Storbritannien',
          'Den skrevs för att trösta ett barn vars föräldrar skilde sig',
          'Låten är över sju minuter lång, ovanligt för sin tid',
          'Barnet låten skrevs till var son till en av bandmedlemmarna',
        ] },
        { line: 'And I will always love you', song: 'I Will Always Love You', artist: 'Whitney Houston', hints: [
          'Låten kom ut på 1990-talet',
          'Den är en cover av en countrylåt, ursprungligen skriven av Dolly Parton',
          'Artisten kommer från USA',
          "Versionen är från soundtracket till filmen 'The Bodyguard'",
          'Artisten sjunger a cappella, utan musik, i låtens allra första sekunder',
          'Låten låg etta på topplistorna i många veckor i rad',
        ] },
        { line: 'You can stand under my umbrella', song: 'Umbrella', artist: 'Rihanna', hints: [
          'Låten kom ut på 2000-talet',
          "Den har ett upprepat 'ella ella' i refrängen",
          'Artisten kommer från Barbados',
          'Låten hade en gästrappare i originalversionen',
          'Låten handlar om att stå kvar vid någons sida, inte om väder',
          'Den vann flera stora musikpriser samma år som den släpptes',
        ] },
        { line: 'We could have had it all', song: 'Rolling in the Deep', artist: 'Adele', hints: [
          'Låten kom ut på 2010-talet',
          'Den handlar om ett bittert uppbrott',
          'Artisten kommer från Storbritannien',
          "Låten är från albumet '21', uppkallat efter artistens ålder",
          'Låten blandar soul med bluesinfluerade trummor',
          'Den blev artistens första stora internationella genombrottslåt i USA',
        ] },
        { line: "I'm in love with the shape of you", song: 'Shape of You', artist: 'Ed Sheeran', hints: [
          'Låten kom ut på 2010-talet',
          'Den var en av de mest streamade låtarna någonsin vid releasen',
          'Artisten kommer från Storbritannien',
          'Artisten är känd för att bygga låtar med enbart loop-pedal live',
          'Låten skrevs ursprungligen med tanken att en annan stor artist skulle sjunga den',
          'Refrängen bygger på en marimba-liknande melodislinga',
          'Låten låg etta i över ett dussin länder samtidigt',
          'Den var artistens mest streamade låt under flera år i rad',
        ] },
      ],
    },
  ],
  ...
  damer_gubbar: [
    {
      id: 'uppvarmning',
      title: 'Verktyg & Skönhet',
      desc: 'Blandade frågor om bilar, verktyg, smink och mode — ingen kommer undan',
      type: 'quiz',
      difficulty: 'lätt',
      questions: [
        { q: 'Vilket verktyg använder man för att skruva i en skruv?', options: ['Skiftnyckel', 'Skruvmejsel', 'Hammare', 'Tång'], answer: 1 },
        { q: 'Vilket märke tillverkar bilmodellen "Golf"?', options: ['Volkswagen', 'Volvo', 'Ford', 'Opel'], answer: 0 },
        { q: 'Vilket smink används för att göra ögonfransarna mörkare och längre?', options: ['Mascara', 'Concealer', 'Highlighter', 'Primer'], answer: 0 },
        { q: 'Vilket modehus skapade den klassiska "little black dress"?', options: ['Chanel', 'Gucci', 'Prada', 'Versace'], answer: 0 },
        { q: 'Hur många däck har en vanlig personbil?', options: ['3', '4', '5', '6'], answer: 1 },
        { q: 'Vilket verktyg använder man för att se om något hänger rakt?', options: ['Vattenpass', 'Tumstock', 'Skruvdragare', 'Hammare'], answer: 0 },
        { q: 'Vilken doftfamilj beskrivs oftast som "blommig"?', options: ['Floral', 'Oriental', 'Citrus', 'Träig'], answer: 0 },
        { q: 'Vilken årlig biltävling körs på gatorna i Monaco?', options: ['Monaco Grand Prix', 'Monaco Rally', 'Monaco Cup', 'Monaco Marathon'], answer: 0 },
        { q: 'Vilken sport spelas med klubbor på en bana med 18 hål?', options: ['Golf', 'Krocket', 'Boule', 'Tennis'], answer: 0 },
        { q: 'Vad heter den klassiska handväskan från Hermès, uppkallad efter en brittisk skådespelerska?', options: ['Birkin', 'Kelly', 'Chanel 2.55', 'Lady Dior'], answer: 0 },
      ],
    },
    {
      id: 'pubniva',
      title: 'Motorer & Modehus',
      desc: 'Lite kluringare — teknik, bilmärken, skönhetsrutiner och designers',
      type: 'quiz',
      difficulty: 'mellan',
      questions: [
        { q: 'Vilket år lanserades den första iPhone?', options: ['2005', '2007', '2009', '2010'], answer: 1 },
        { q: 'Från vilket land kommer den populära "10-stegsrutinen" inom hudvård?', options: ['Sydkorea', 'Japan', 'Frankrike', 'USA'], answer: 0 },
        { q: 'Hur många hästkrafter har en vanlig bensindriven gräsklippare ungefär?', options: ['1-2 hk', '3-6 hk', '10-15 hk', '20-25 hk'], answer: 1 },
        { q: 'Vilket modehus har dubbla C som logotyp?', options: ['Chanel', 'Dior', 'YSL', 'Gucci'], answer: 0 },
        { q: 'Vilken biltillverkare gör modellen "Mustang"?', options: ['Ford', 'Chevrolet', 'Dodge', 'Chrysler'], answer: 0 },
        { q: 'Vad kallas sminktekniken som ger ansiktet en smalare, mer konturerad form?', options: ['Contouring', 'Baking', 'Strobing', 'Highlighting'], answer: 0 },
        { q: 'Vilket verktyg mäter elektrisk spänning?', options: ['Voltmeter', 'Amperemeter', 'Barometer', 'Termometer'], answer: 0 },
        { q: 'Vilken designer skapade "New Look" som förnyade kvinnomode efter andra världskriget?', options: ['Christian Dior', 'Coco Chanel', 'Yves Saint Laurent', 'Giorgio Armani'], answer: 0 },
        { q: 'Vad står förkortningen "SUV" för?', options: ['Sport Utility Vehicle', 'Super Utility Van', 'Standard Urban Vehicle', 'Sport Under Vehicle'], answer: 0 },
        { q: 'Vilket år grundades kosmetikmärket MAC?', options: ['1975', '1984', '1991', '1999'], answer: 1 },
      ],
    },
    {
      id: 'quizmastare',
      title: 'Experten på båda sidor',
      desc: 'För dig som kan både motorer och modehistoria på djupet',
      type: 'quiz',
      difficulty: 'svårt',
      questions: [
        { q: 'Vad står förkortningen "ABS" för i bilsammanhang?', options: ['Anti-lock Braking System', 'Automatic Brake Sensor', 'Advanced Body Structure', 'Automatic Balance System'], answer: 0 },
        { q: 'Vem grundade modehuset Chanel?', options: ['Coco Chanel', 'Elsa Schiaparelli', 'Madeleine Vionnet', 'Jeanne Lanvin'], answer: 0 },
        { q: 'Vilket år lanserade Dior parfymen "J\'adore"?', options: ['1985', '1999', '2005', '2010'], answer: 1 },
        { q: 'Vilken finsk förare vann F1-VM 1982?', options: ['Keke Rosberg', 'Alain Prost', 'Niki Lauda', 'Nelson Piquet'], answer: 0 },
        { q: 'Vilket år grundades kosmetikföretaget Estée Lauder?', options: ['1936', '1946', '1956', '1966'], answer: 1 },
        { q: 'Vilket instrument i en bil visar motorns varvtal?', options: ['Varvräknare', 'Hastighetsmätare', 'Bränslemätare', 'Oljetrycksmätare'], answer: 0 },
        { q: 'Vem designade den ikoniska klänningen Audrey Hepburn bar i "Breakfast at Tiffany\'s"?', options: ['Hubert de Givenchy', 'Coco Chanel', 'Christian Dior', 'Yves Saint Laurent'], answer: 0 },
        { q: 'Hur många cylindrar har en klassisk Volvo "fem-a"-motor?', options: ['4', '5', '6', '8'], answer: 1 },
        { q: 'Vilket år lanserade Chanel den klassiska parfymen "No. 5"?', options: ['1911', '1921', '1931', '1941'], answer: 1 },
        { q: 'Vad kallas det när man byter ut hjulen på en bil för att anpassa dem efter säsong?', options: ['Däckskifte', 'Boost', 'Tuning', 'Justering'], answer: 0 },
      ],
    },
  ],
  ...
  dejt: [
    {
      id: 'forsta-dejten',
      title: 'Första dejten',
      desc: 'Roliga frågor om vad man faktiskt pratar om (och borde undvika) på en första dejt',
      type: 'quiz',
      difficulty: 'lätt',
      questions: [
        { q: 'Vilken är en klassisk "säker" issbrytarfråga på en första dejt?', options: ['Vad gör du helst en ledig helg?', 'Vad var ditt värsta ex mest känt för?', 'Hur mycket tjänar du i månaden?', 'Vad väger du?'], answer: 0 },
        { q: 'Vad brukar dejtingexperter säga är det bästa sättet att öppna konversationen?', options: ['Prata om vädret i tio minuter', 'Ställa en öppen fråga om personen', 'Berätta hela din CV', 'Sitta tyst och vänta'], answer: 1 },
        { q: 'Vilken fråga räknas som en klassisk "red flag-detektor" på en dejt?', options: ['Hur är din relation med din familj?', 'Vilken är din favoritfärg?', 'Vad åt du till frukost?', 'Vilket väder gillar du bäst?'], answer: 0 },
        { q: 'Enligt gammal dejtetikett — vem brukar traditionellt föreslå var man ska ses på en första dejt?', options: ['Den som bjöd in', 'Google Maps', 'Restaurangen väljer själv', 'Man möts bara på gatan'], answer: 0 },
        { q: 'Vilken fråga är en klassisk "go-to" för att bryta pinsam tystnad på en dejt?', options: ['Vad är din bästa pinsamma historia?', 'Kan du periodiska systemet utantill?', 'Hur många ex har du haft?', 'Vad tycker du om deklarationsblanketter?'], answer: 0 },
        { q: 'Vilken fråga används ofta för att se om ni har samma humor?', options: ['Vad är det roligaste som hänt dig?', 'Vad har du i lön?', 'Hur gammal är din mamma?', 'Vad är ditt personnummer?'], answer: 0 },
        { q: 'Vilken aktivitet räknas som en klassisk "lågstress"-förstadejt?', options: ['Fika på ett kafé', 'Bungyjump', 'Skattedeklaration ihop', 'Springa ett maraton'], answer: 0 },
        { q: 'Vad avråder de flesta dejtingexperter från att prata för mycket om på en första dejt?', options: ['Sina exälskare', 'Sina hobbyer', 'Sin favoritmat', 'Sina husdjur'], answer: 0 },
        { q: 'Vilken fråga är en klassiker för att ta reda på någons framtidsplaner utan att låta för seriös?', options: ['Vad drömmer du om att göra om fem år?', 'Vill du gifta dig med mig?', 'Hur ser ditt testamente ut?', 'Vad är din kreditvärdighet?'], answer: 0 },
        { q: 'Vad säger dejtingexperter ofta är ett bra tecken på att en första dejt går bra?', options: ['Ni tappar tidsuppfattningen', 'Ni kollar klockan var femte minut', 'Ni pratar bara om jobbet', 'Ingen av er ler'], answer: 0 },
      ],
    },
    {
      id: 'andra-dejten',
      title: 'Dejtingjargong',
      desc: 'Begrepp och historia från dejtingens värld',
      type: 'quiz',
      difficulty: 'mellan',
      questions: [
        { q: 'Vilket svenskt TV-program handlar om en bonde som söker kärlek?', options: ['Bonde söker fru', 'Sommar med Ernst', 'Allsång på Skansen', 'Idol'], answer: 0 },
        { q: 'Vad kallas det när någon överöser dig med romantik och uppmärksamhet i början för att snabbt vinna ditt förtroende?', options: ['Love bombing', 'Ghosting', 'Benching', 'Breadcrumbing'], answer: 0 },
        { q: 'Vilket år lanserades appen Tinder?', options: ['2010', '2012', '2014', '2016'], answer: 1 },
        { q: 'Vad kallas det när någon låtsas vara en annan person online, ofta med stulna bilder?', options: ['Catfishing', 'Ghosting', 'Phishing', 'Trolling'], answer: 0 },
        { q: 'I vilket land uppfanns konceptet "speed dating" på 1990-talet?', options: ['USA', 'Storbritannien', 'Frankrike', 'Israel'], answer: 0 },
        { q: 'Vad kallas det att hålla kvar någon som "reserv" utan att vilja committa på riktigt?', options: ['Benching', 'Ghosting', 'Breadcrumbing', 'Orbiting'], answer: 0 },
        { q: 'Vad heter det klassiska konceptet "blind date" på svenska?', options: ['Blind dejt', 'Snabbträff', 'Hemlig träff', 'Mörk dejt'], answer: 0 },
        { q: 'Vilken dejtingapp är särskilt populär bland homosexuella män?', options: ['Grindr', 'Tinder', 'Bumble', 'Hinge'], answer: 0 },
        { q: 'Vad kallas det att gilla-markera någons inlägg utan att faktiskt prata med personen, för att hålla sig "top of mind"?', options: ['Orbiting', 'Benching', 'Ghosting', 'Zombieing'], answer: 0 },
        { q: 'Vilket år grundades en av de första stora dejtingsajterna online, Match.com?', options: ['1993', '1995', '1997', '1999'], answer: 1 },
      ],
    },
    {
      id: 'tredje-dejten',
      title: 'Kärlekens experter',
      desc: 'Forskning, psykologi och obskyr dejtinghistoria',
      type: 'quiz',
      difficulty: 'svårt',
      questions: [
        { q: 'Vad kallas det när en person som "ghostat" dig plötsligt dyker upp igen som om inget hänt?', options: ['Zombieing', 'Benching', 'Orbiting', 'Breadcrumbing'], answer: 0 },
        { q: 'Vilken psykolog myntade begreppet "de fem kärleksspråken"?', options: ['Gary Chapman', 'John Gottman', 'Esther Perel', 'Helen Fisher'], answer: 0 },
        { q: 'Enligt forskaren Helen Fisher, hur många grundläggande hjärnsystem är kopplade till kärlek och parbildning?', options: ['2', '3', '4', '5'], answer: 1 },
        { q: 'Vad kallas ett förhållande som inte är officiellt exklusivt, ofta innan man "sätter en etikett" på det?', options: ['Talking stage', 'Situationship', 'Friend zone', 'Soft launch'], answer: 1 },
        { q: 'Vad kallas det att diskret börja visa upp en ny partner på sociala medier utan att avslöja hela relationen på en gång?', options: ['Soft launch', 'Hard launch', 'Love bombing', 'Breadcrumbing'], answer: 0 },
        { q: 'Vilken forskare är känd för sitt arbete om "de fyra ryttarna" som förutsäger skilsmässa?', options: ['John Gottman', 'Gary Chapman', 'Esther Perel', 'Sue Johnson'], answer: 0 },
        { q: 'Vad kallas en trygg anknytningsstil i relationer, enligt bindningsteorin?', options: ['Secure attachment', 'Anxious attachment', 'Avoidant attachment', 'Disorganized attachment'], answer: 0 },
        { q: 'Vilket år lanserades appen Bumble, känd för att kvinnor måste skicka första meddelandet?', options: ['2012', '2014', '2016', '2018'], answer: 1 },
        { q: 'Vad kallas en relation som mest hålls igång via sms/meddelanden utan fysiska träffar?', options: ['Textationship', 'Situationship', 'Ghosting', 'Benching'], answer: 0 },
        { q: 'Vem myntade uttrycket "kärlek vid första ögonkastet" i en pjäs redan på 1500-talet?', options: ['William Shakespeare', 'Christopher Marlowe', 'Dante Alighieri', 'Geoffrey Chaucer'], answer: 0 },
      ],
    },
  ],
  ...
  livskunskap: [
    {
      id: 'grunder',
      title: 'Vardagskoll',
      desc: 'Sånt alla vuxna borde veta om vardagen i Sverige',
      type: 'quiz',
      difficulty: 'lätt',
      questions: [
        { q: 'Vilket nummer ringer man vid nödsituationer i Sverige?', options: ['112', '911', '110', '100'], answer: 0 },
        { q: 'Hur många procent moms är den vanligaste momssatsen i Sverige?', options: ['6%', '12%', '25%', '30%'], answer: 2 },
        { q: 'Vid vilken ålder får man rösta i svenska val?', options: ['16 år', '18 år', '20 år', '21 år'], answer: 1 },
        { q: 'Vad heter myndigheten som hanterar skatter i Sverige?', options: ['Skatteverket', 'Försäkringskassan', 'Kronofogden', 'Bolagsverket'], answer: 0 },
        { q: 'Hur lång är den lagstadgade minsta uppsägningstiden vid en tillsvidareanställning från start?', options: ['2 veckor', '1 månad', '2 månader', '3 månader'], answer: 1 },
        { q: 'Vad bör man alltid göra innan man kör iväg med bilen?', options: ['Sätta på bilbälte', 'Starta radion', 'Ringa ett samtal', 'Äta en smörgås'], answer: 0 },
        { q: 'Vilken myndighet ansvarar för sjukpenning och föräldrapenning i Sverige?', options: ['Försäkringskassan', 'Skatteverket', 'Arbetsförmedlingen', 'Kronofogden'], answer: 0 },
        { q: 'Hur länge gäller normalt ångerrätten vid köp online inom EU?', options: ['7 dagar', '14 dagar', '30 dagar', '60 dagar'], answer: 1 },
        { q: 'Vad kallas det svenska systemet där staten sköter försäljning av starksprit, vin och starköl?', options: ['Systembolaget', 'ICA', 'Alkobolaget', 'Vinmonopolet'], answer: 0 },
        { q: 'Vilken är åldersgränsen för att köpa folköl i en vanlig livsmedelsbutik i Sverige?', options: ['16 år', '18 år', '20 år', '21 år'], answer: 1 },
      ],
    },
    {
      id: 'vuxenliv',
      title: 'Vuxenkunskap',
      desc: 'Lite kluringare — ekonomi, rättigheter och första hjälpen',
      type: 'quiz',
      difficulty: 'mellan',
      questions: [
        { q: 'Hur många procent brukar bankerna kräva i kontantinsats vid bostadsköp i Sverige?', options: ['5%', '10%', '15%', '20%'], answer: 2 },
        { q: 'Vad heter den svenska lagen som skyddar konsumenter vid köp av varor och tjänster?', options: ['Konsumentköplagen', 'Avtalslagen', 'Skadeståndslagen', 'Marknadsföringslagen'], answer: 0 },
        { q: 'Hur många semesterdagar har man minst rätt till per år enligt svensk semesterlag?', options: ['20', '25', '28', '30'], answer: 1 },
        { q: 'Vilken myndighet driver in obetalda skulder i Sverige?', options: ['Kronofogden', 'Skatteverket', 'Inkasso AB', 'Konsumentverket'], answer: 0 },
        { q: 'Hur lång är den lagstadgade minsta uppsägningstiden från arbetsgivaren efter 10 års anställning?', options: ['3 månader', '4 månader', '5 månader', '6 månader'], answer: 3 },
        { q: 'Hur mycket statlig inkomstskatt betalar man ungefär utöver kommunalskatten, om man tjänar över brytpunkten?', options: ['20%', '25%', '30%', '35%'], answer: 0 },
        { q: 'Vad heter principen som ger dig rätt att vandra och plocka bär på annans mark i Sverige?', options: ['Allemansrätten', 'Strandskyddet', 'Naturvårdslagen', 'Friluftslagen'], answer: 0 },
        { q: 'Hur länge sparas normalt en betalningsanmärkning hos en privatperson i Sverige?', options: ['1 år', '3 år', '5 år', '10 år'], answer: 1 },
        { q: 'Vad bör man göra först vid ett misstänkt hjärtstopp, innan HLR påbörjas?', options: ['Ringa 112 och larma', 'Ge personen vatten', 'Vänta och se', 'Flytta personen långt bort'], answer: 0 },
        { q: 'Hur ofta rekommenderas det att man byter batterier i brandvarnaren?', options: ['Varje halvår', 'En gång om året', 'Vartannat år', 'Var femte år'], answer: 1 },
      ],
    },
    {
      id: 'expertliv',
      title: 'Livets finstilta',
      desc: 'För dig som vill kunna paragraferna också',
      type: 'quiz',
      difficulty: 'svårt',
      questions: [
        { q: 'Hur många år är preskriptionstiden för en vanlig skuld mot en konsument i Sverige?', options: ['2 år', '3 år', '5 år', '10 år'], answer: 1 },
        { q: 'Vad kallas lagen som ger dig ångerrätt vid köp som gjorts utanför ordinarie affärslokal, t.ex. dörrknackning?', options: ['Distansavtalslagen', 'Konsumentköplagen', 'Hemförsäljningslagen', 'Avtalslagen'], answer: 0 },
        { q: 'Ungefär hur hög var brytpunkten för statlig skatt i Sverige (årsinkomst) 2024?', options: ['ca 400 000 kr', 'ca 615 000 kr', 'ca 800 000 kr', 'ca 1 000 000 kr'], answer: 1 },
        { q: 'Vad heter principen inom avtalsrätt som innebär att avtal ska hållas?', options: ['Pacta sunt servanda', 'Caveat emptor', 'Force majeure', 'Bona fide'], answer: 0 },
        { q: 'Hur många år tar det innan en skuld mellan två företag preskriberas, om inget avbryter preskriptionen?', options: ['3 år', '5 år', '10 år', '15 år'], answer: 2 },
        { q: 'Vilken balk i svensk lag innehåller reglerna om hyra av bostad, den så kallade "hyreslagen"?', options: ['Jordabalken', 'Skuldebrevslagen', 'Föräldrabalken', 'Brottsbalken'], answer: 0 },
        { q: 'Hur stor är insättningsgarantin per person och bank i Sverige om banken skulle gå i konkurs?', options: ['100 000 kr', 'ca 950 000 kr', '500 000 kr', '1 500 000 kr'], answer: 1 },
        { q: 'Vilken myndighet utfärdar svenska pass?', options: ['Polisen', 'Skatteverket', 'Migrationsverket', 'Länsstyrelsen'], answer: 0 },
        { q: 'Hur många dagar med föräldrapenning har föräldrar rätt till sammanlagt per barn i Sverige?', options: ['390 dagar', '420 dagar', '480 dagar', '540 dagar'], answer: 2 },
        { q: 'Vad kallas det juridiska begreppet som innebär straffansvar om man underlåter att hjälpa någon i uppenbar livsfara, trots att det kunnat ske utan fara?', options: ['Underlåtenhet att hjälpa nödställd', 'Nödvärn', 'Nödrätt', 'Civilkurageplikten'], answer: 0 },
      ],
    },
  ],
  ...
  citat: [
    {
      id: 'kanda-repliker',
      title: 'Kända repliker',
      desc: 'Klassiska citat från film och historia — vem sa det?',
      type: 'quiz',
      difficulty: 'lätt',
      questions: [
        { q: 'Vem sa "I have a dream"?', options: ['Martin Luther King Jr.', 'Nelson Mandela', 'Barack Obama', 'Malcolm X'], answer: 0 },
        { q: 'Vem sa (enligt legenden) "Houston, we have a problem"?', options: ['Jim Lovell', 'Neil Armstrong', 'Buzz Aldrin', 'John Glenn'], answer: 0 },
        { q: 'Vilken karaktär förknippas med repliken "Elementärt, min käre Watson"?', options: ['Sherlock Holmes', 'Hercule Poirot', 'Miss Marple', 'Dr. Watson'], answer: 0 },
        { q: 'Vem sa "I\'ll be back" i filmen Terminator?', options: ['Arnold Schwarzenegger', 'Sylvester Stallone', 'Bruce Willis', 'Jean-Claude Van Damme'], answer: 0 },
        { q: 'Vem sa "Ask not what your country can do for you"?', options: ['John F. Kennedy', 'Ronald Reagan', 'Richard Nixon', 'Bill Clinton'], answer: 0 },
        { q: 'Vem sa "That\'s one small step for man, one giant leap for mankind"?', options: ['Neil Armstrong', 'Buzz Aldrin', 'Michael Collins', 'Yuri Gagarin'], answer: 0 },
        { q: 'Vem säger repliken "Show me the money!" i filmen Jerry Maguire?', options: ['Tom Cruise (Jerry)', 'Cuba Gooding Jr. (Rod)', 'Renée Zellweger', 'Brad Pitt'], answer: 1 },
        { q: 'Vem säger "Jag är kungen på världen!" i Titanic?', options: ['Leonardo DiCaprio (Jack)', 'Kate Winslet (Rose)', 'Billy Zane', 'Kathy Bates'], answer: 0 },
        { q: 'Vilken karaktär säger "Life is like a box of chocolates"?', options: ['Forrest Gump', 'Rocky Balboa', 'Jack Sparrow', 'Marty McFly'], answer: 0 },
        { q: 'Vem skrev repliken "To be or not to be, that is the question"?', options: ['William Shakespeare', 'Christopher Marlowe', 'Charles Dickens', 'Oscar Wilde'], answer: 0 },
      ],
    },
    {
      id: 'historiska-citat',
      title: 'Historiska citat',
      desc: 'Ledare, boxare och gudfäder — kluringare attribueringar',
      type: 'quiz',
      difficulty: 'mellan',
      questions: [
        { q: 'Vem sa "Blood, toil, tears and sweat" som brittisk premiärminister under andra världskriget?', options: ['Winston Churchill', 'Neville Chamberlain', 'Margaret Thatcher', 'Tony Blair'], answer: 0 },
        { q: 'Vem sa "Float like a butterfly, sting like a bee"?', options: ['Muhammad Ali', 'Mike Tyson', 'George Foreman', 'Sugar Ray Robinson'], answer: 0 },
        { q: 'Vem säger "I\'m gonna make him an offer he can\'t refuse" i Gudfadern?', options: ['Vito Corleone', 'Michael Corleone', 'Sonny Corleone', 'Tom Hagen'], answer: 0 },
        { q: 'Vem sa "We shall fight on the beaches"?', options: ['Winston Churchill', 'Franklin D. Roosevelt', 'Charles de Gaulle', 'Dwight D. Eisenhower'], answer: 0 },
        { q: 'Vem tillskrivs citatet "Failing to prepare is preparing to fail"?', options: ['Benjamin Franklin', 'Winston Churchill', 'Abraham Lincoln', 'Thomas Edison'], answer: 0 },
        { q: 'Vem tillskrivs citatet "Var den förändring du vill se i världen"?', options: ['Mahatma Gandhi', 'Martin Luther King Jr.', 'Nelson Mandela', 'Dalai Lama'], answer: 0 },
        { q: 'Vem sa "Cogito, ergo sum" ("Jag tänker, alltså är jag")?', options: ['René Descartes', 'Aristoteles', 'Platon', 'Immanuel Kant'], answer: 0 },
        { q: 'Vem sa "Makt korrumperar, absolut makt korrumperar totalt"?', options: ['Lord Acton', 'Winston Churchill', 'Karl Marx', 'Machiavelli'], answer: 0 },
        { q: 'Vem sa "Ge mig frihet eller ge mig döden"?', options: ['Patrick Henry', 'Thomas Jefferson', 'George Washington', 'Benjamin Franklin'], answer: 0 },
        { q: 'Vem sa "Kunskap är makt"?', options: ['Francis Bacon', 'Isaac Newton', 'John Locke', 'Voltaire'], answer: 0 },
      ],
    },
    {
      id: 'filosofiska-citat',
      title: 'Filosofernas mästare',
      desc: 'För dig som citerar Nietzsche på en lördagskväll',
      type: 'quiz',
      difficulty: 'svårt',
      questions: [
        { q: 'Vem sa "Gud är död"?', options: ['Friedrich Nietzsche', 'Karl Marx', 'Sigmund Freud', 'Arthur Schopenhauer'], answer: 0 },
        { q: 'Vem sa "Jag vet bara att jag ingenting vet"?', options: ['Sokrates', 'Platon', 'Aristoteles', 'Pythagoras'], answer: 0 },
        { q: 'Vem sa "Historien upprepar sig, första gången som tragedi, andra gången som fars"?', options: ['Karl Marx', 'Georg Hegel', 'Friedrich Engels', 'Vladimir Lenin'], answer: 0 },
        { q: 'Vem sa "Att vara stor är att bli missförstådd"?', options: ['Ralph Waldo Emerson', 'Henry David Thoreau', 'Walt Whitman', 'Mark Twain'], answer: 0 },
        { q: 'Vem myntade tanken att "kriget är en fortsättning av politiken med andra medel"?', options: ['Carl von Clausewitz', 'Sun Tzu', 'Napoleon Bonaparte', 'Otto von Bismarck'], answer: 0 },
        { q: 'Vem tillskrivs citatet "Den som ger upp friheten för trygghet förtjänar varken"?', options: ['Benjamin Franklin', 'Thomas Jefferson', 'John Adams', 'Alexander Hamilton'], answer: 0 },
        { q: 'Vem sa "L\'État, c\'est moi" ("Staten, det är jag")?', options: ['Ludvig XIV', 'Napoleon Bonaparte', 'Ludvig XVI', 'Karl den store'], answer: 0 },
        { q: 'Vem sa "Var ditt eget ljus" ("Be a lamp unto yourself")?', options: ['Buddha', 'Konfucius', 'Lao Tzu', 'Dalai Lama'], answer: 0 },
        { q: 'Vem sa "Det enda konstanta i livet är förändring"?', options: ['Herakleitos', 'Sokrates', 'Platon', 'Aristoteles'], answer: 0 },
        { q: 'Vem sa "Jag tänker aldrig på framtiden, den kommer ändå snart nog"?', options: ['Albert Einstein', 'Isaac Newton', 'Nikola Tesla', 'Stephen Hawking'], answer: 0 },
      ],
    },
  ],
}
